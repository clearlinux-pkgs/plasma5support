...
Version  : 6.0.5
Release  : 4
URL      : https://download.kde.org/stable/plasma/6.0.5/plasma5support-6.0.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.5/plasma5support-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/plasma5support-6.0.5.tar.xz.sig
...
%setup -q -n plasma5support-6.0.5
cd %{_builddir}/plasma5support-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716480280
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma5Support.so.6.0.5
