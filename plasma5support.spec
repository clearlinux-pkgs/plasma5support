...
Source0  : https://download.kde.org/stable/plasma/6.3.0/plasma5support-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.0/plasma5support-6.3.0.tar.xz.sig
...
%setup -q -n plasma5support-6.3.0
cd %{_builddir}/plasma5support-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739304130
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma5Support.so.6.3.0
/usr/lib64/libplasma-geolocation-interface.so.6
/usr/lib64/libplasma-geolocation-interface.so.6.3.0
