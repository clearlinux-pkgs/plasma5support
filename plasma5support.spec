...
%setup -q -n plasma5support-6.3.5
cd %{_builddir}/plasma5support-6.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747167472
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma5Support.so.6.3.5
/usr/lib64/libplasma-geolocation-interface.so.6
/usr/lib64/libplasma-geolocation-interface.so.6.3.5
