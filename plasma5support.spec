...
Source0  : https://download.kde.org/stable/plasma/6.1.5/plasma5support-6.1.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.5/plasma5support-6.1.5.tar.xz.sig
...
%setup -q -n plasma5support-6.1.5
cd %{_builddir}/plasma5support-6.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726002422
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma5Support.so.6.1.5
...
%files locales -f libplasma5support.lang -f plasma_engine_devicenotifications.lang -f plasma_engine_keystate.lang
%defattr(-,root,root,-)
