...
Source0  : https://download.kde.org/stable/plasma/6.3.1/plasma5support-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/plasma5support-6.3.1.tar.xz.sig
...
%setup -q -n plasma5support-6.3.1
cd %{_builddir}/plasma5support-6.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739914287
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma5Support.so.6.3.1
/usr/lib64/libplasma-geolocation-interface.so.6
/usr/lib64/libplasma-geolocation-interface.so.6.3.1
