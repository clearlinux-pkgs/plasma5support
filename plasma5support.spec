...
Source0  : https://download.kde.org/stable/plasma/6.1.4/plasma5support-6.1.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.4/plasma5support-6.1.4.tar.xz.sig
...
%setup -q -n plasma5support-6.1.4
cd %{_builddir}/plasma5support-6.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723147391
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma5Support.so.6.1.4
