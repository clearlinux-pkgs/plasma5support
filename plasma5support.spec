...
Source0  : https://download.kde.org/stable/plasma/6.3.3/plasma5support-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/plasma5support-6.3.3.tar.xz.sig
...
%setup -q -n plasma5support-6.3.3
cd %{_builddir}/plasma5support-6.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742532308
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma5Support.so.6.3.3
/usr/lib64/libplasma-geolocation-interface.so.6
/usr/lib64/libplasma-geolocation-interface.so.6.3.3
