...
Source0  : https://download.kde.org/stable/plasma/6.2.0/plasma5support-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/plasma5support-6.2.0.tar.xz.sig
...
%setup -q -n plasma5support-6.2.0
cd %{_builddir}/plasma5support-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728775615
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libPlasma5Support.so.6.2.0
...
%files locales -f libplasma5support.lang -f plasma_engine_devicenotifications.lang -f plasma_engine_hotplug.lang -f plasma_engine_keystate.lang -f plasma_engine_soliddevice.lang
%defattr(-,root,root,-)
